...
The live dashboard images can be found in the MEDIA/DASHBOARD/Dash1.png(https://github.com/saganash-21/ESP32-Cloud-Environment-Monitor/blob/main/MEDIA/DASHBOARD/Dash1.png) folder.
